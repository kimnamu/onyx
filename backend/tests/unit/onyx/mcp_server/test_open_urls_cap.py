...
from onyx.server.features.web_search.models import MAX_OPEN_URLS_PER_REQUEST


@pytest.mark.asyncio
async def test_open_urls_rejects_more_than_cap(
    ...
    urls = [f"https://example.com/{i}" for i in range(MAX_OPEN_URLS_PER_REQUEST + 1)]
