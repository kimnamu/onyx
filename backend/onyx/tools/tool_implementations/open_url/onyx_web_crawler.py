...
# Wall-clock bound on reading one response body (per-read timeouts alone let a
# slow-drip server hold the worker indefinitely).
DEFAULT_BODY_DEADLINE_SECONDS = 60
...
class OnyxWebCrawler(WebContentProvider):
    ...
    def __init__(
        ...
        *,
        ...
        body_deadline_seconds: float = DEFAULT_BODY_DEADLINE_SECONDS,
    ) -> None:
